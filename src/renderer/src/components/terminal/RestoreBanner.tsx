...
/**
 * Proposée quand la session tmux a dû être recréée — après un redémarrage de la
 * machine, qui emporte le serveur tmux. L'écran d'avant est réaffiché derrière,
 * et cette bande dit ce qu'il est possible de reprendre.
 */
